...
cl /nologo /O1ityb2 /Gs /G6 /FAs /QIfist %file%.cpp /link /warn:0 /nodefaultlib /entry:main /libpath:F:\masm32\lib kernel32.lib user32.lib gdi32.lib opengl32.lib glu32.lib /align:4096 /merge:.text=.data /merge:.rdata=.data /subsystem:windows
...
static const char scrolltext[] =
    "                               "
    "The Worlds Best Electronic Music Tracker -- w w w . t o r r e n t e c h . o r g       "
    "   Techno, Trance, Breaks & More ...        ";

inline __int64 rdtsc() { __asm rdtsc }

#define g_width 800                          // change to 640 / 480 if you
#define g_height 600                         // have a slow enough machine
